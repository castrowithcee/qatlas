...
Diese Regel gilt, sobald im Projekt `.qatlas/project/` existiert oder der Einstiegsskill es anlegt. Der Ordner
...
Bevor du außerhalb von `.qatlas/project/backlog/` eine Datei im Scaffold erstellst, inhaltlich änderst,
